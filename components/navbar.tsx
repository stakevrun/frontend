...
const Navbar: NextPage = () => {
          ...
          for (const [minAddress, pubkey] of attachedPubkeyArray) {
            if (minAddress === "Null minipool") {
              ...
              const DAOAddress = await storageContract["getAddress(bytes32)"](
                ethers.id(
                  "contract.addressrocketDAONodeTrustedSettingsMinipool"
                )
              );
              ...
              const withdrawalCountdown =
                (Number(withdrawalEpoch) - Number(currentEpoch)) *
                12 *
                32 *
                1000;
              ...
              seperateMinipoolObjects.push({
                ...
                valBalance: ethers
                  .formatUnits(newValBalance, "gwei")
                  .toString(),
  ...
  return (
    <header
      ...
      className="p-2 w-full h-auto flex flex-col items-center justify-center sticky top-0 z-50 shadow-md lg:h-[9vh]"
    >
      <div className="mx-auto w-[90%] flex items-center justify-center gap-5">
        <div className="flex h-14 items-center  justify-between w-full rounded-lg md:px-3">
          <div className="hidden items-center justify-center gap-8 lg:flex ">
            <Link
              className="flex flex-row items-left justify-center gap-2"
              href="/"
            >
              <Image
                height={30}
      ...
      {address !== undefined ? (
        <div className="ml-1 mt-4 gap-5 flex w-full items-center justify-center gap-2 block lg:hidden">
