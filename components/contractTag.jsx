  ...
  return (
    <span className='flex items-center flex-col gap-2 justify-center  text-center text-wrap w-full xl:flex-row '>
       ...
       <span className='relative cursor-pointer'>
            <span className="absolute top-7  text-gray-800  bg-gray-200 shadow-lg border-white-2 font-bold rounded-lg p-2 text-xs " style={styles}><span>Copy Address</span></span>
            <AiFillCopy className="text-xl" onClick={handleCopyClick} onMouseEnter={changeStyles} onMouseLeave={revertStyles}/>
          </span>
        )}
        {copied && (
          <span className='relative cursor-pointer'>
            <span  className="absolute top-7 text-gray-800  bg-gray-200 shadow-lg border-white-2 font-bold rounded-lg p-2 text-xs " style={styles}><span>Copied!</span></span>
