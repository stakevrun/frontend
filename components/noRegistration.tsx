...
const NoRegistration = ({ onRegistrationResult }: any) => {
  ...
  const storageABI = [
    ...
    },
    {
      inputs: [{ internalType: "bytes32", name: "_key", type: "bytes32" }],
      name: "getBytes32",
      outputs: [{ internalType: "bytes32", name: "r", type: "bytes32" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    },
    {
      inputs: [{ internalType: "bytes32", name: "_key", type: "bytes32" }],
      name: "getInt",
      outputs: [{ internalType: "int256", name: "r", type: "int256" }],
      stateMutability: "view",
      type: "function",
    },
    {
  ...
  const managerABI = [
      ...
      outputs: [
        {
          components: [
            ...
            { internalType: "uint256", name: "rewardNetwork", type: "uint256" },
            { internalType: "uint256", name: "rplStake", type: "uint256" },
            {
              internalType: "uint256",
            ...
            { internalType: "uint256", name: "ethMatched", type: "uint256" },
            {
              internalType: "uint256",
              name: "ethMatchedLimit",
              type: "uint256",
            },
            { internalType: "uint256", name: "minipoolCount", type: "uint256" },
            { internalType: "uint256", name: "balanceETH", type: "uint256" },
            { internalType: "uint256", name: "balanceRETH", type: "uint256" },
            { internalType: "uint256", name: "balanceRPL", type: "uint256" },
            { internalType: "uint256", name: "balanceOldRPL", type: "uint256" },
            {
              internalType: "uint256",
    ...
    {
      inputs: [
        { internalType: "string", name: "_timezoneLocation", type: "string" },
      ],
      name: "registerNode",
      outputs: [],
      stateMutability: "nonpayable",
  ...
  const handleRocketRegistration = async () => {
    ...
    if (typeof (window as any).ethereum !== "undefined") {
      ...
      setIncrementer(5);
      setRegistrationError(
        "No Browser Provider! Unable to continue Transaction... "
      );
    }
  };
    ...
    <div className="w-full min-h-[92vh] h-auto flex flex-col items-center justify-center ">
      <div className="flex flex-col w-auto gap-2  rounded-lg border  px-6 py-6 text-center items-center justify-center shadow-xl">
        ...
        <h2 className="text-2xl font-bold  sm:text-2xl">
          Not Registered with Rocket Pool?
        </h2>
        ...
        <div className="inline-block relative">
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
            <svg
              ...
              viewBox="0 0 20 20"
            >
              <path d="M9 11a1 1 0 0 1-.7-.3l-4-4a1 1 0 1 1 1.4-1.4L9 8.6l6.3-6.3a1 1 0 1 1 1.4 1.4l-7 7a1 1 0 0 1-.7.3z" />
            </svg>
          </div>
        </div>
        ...
        <div className="w-3/5 flex gap-2 pt-5 items-center justify-center">
          <button
            onClick={handleRocketRegistration}
          ...
          {currentRegisterStatus3 === 3 ? (
            <div className="w-full flex items-center flex-col gap-2 justify-center">
              <h3 className="font-bold text-[30px]">
                You are now Registered with Rocket Pool!
              </h3>
            ...
            <>
              <div className="w-full flex items-start flex-col gap-2 justify-center">
                <h3 className="font-bold text-[30px]">
                  Register your Node with Rocket Pool
                </h3>
