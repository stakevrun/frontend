...
const RPLBlock: NextPage = () => {
  ...
  const currentRPC =
    currentChain === 17000
      ? "https://ultra-holy-road.ethereum-holesky.quiknode.pro/b4bcc06d64cddbacb06daf0e82de1026a324ce77/"
  ...
  return (
    <div className="flex flex-col w-auto  h-auto gap-4 px-8 text-center items-center justify-center rounded-xl  border shadow-xl  border-black-100  py-4 ">
      <h2 className="text-2xl w-[90%] font-bold  sm:text-2xl">
        {" "}
        RPL Interface
      </h2>
        ...
        <div className="flex flex-col w-auto px-3  items-center justify-center gap-1 shadow-lg text-md my-3 py-3 px-3 rounded-lg border">
          <label className="flex flex-col font-bold items-center justify-center gap-1">
            ...
            <span className="text-yellow-500 font-bold">
              {" "}
              {roundToTwoDecimalPlaces(ethers.formatEther(RPL))}{" "}
            </span>
          </label>
          ...
          <label className="flex flex-col items-center font-bold justify-center gap-1">
            ...
            >
              {" "}
              {roundToTwoDecimalPlaces(ethers.formatEther(stakeRPL))}{" "}
            </span>
          </label>
          <label className="flex flex-col font-bold items-center justify-center gap-1">
            Active Minipools:
          ...
          <label className="flex flex-col font-bold items-center justify-center gap-1">
            ...
            <span
              className={`text-green-500 font-bold`}
              style={
                Math.floor(Number(ethers.formatEther(newMinipools))) < 1
                  ? { color: "red" }
                  : { color: "rgb(34 197 94)" }
              }
            >
              {" "}
              {Math.floor(Number(ethers.formatEther(newMinipools)))}{" "}
            </span>
          </label>
        </div>
      ) : (
      ...
      <div className="flex flex-col gap-2 items-center justify-center">
        <input
          ...
          style={stakeButtonBool ? { display: "block" } : { display: "none" }}
          type="text"
