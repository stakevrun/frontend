...
<div className="w-full mx-auto max-w-3xl px-6 py-16 sm:py-20 lg:px-8 lg:py-28">
  <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
    <h2 className="text-3xl text-center font-bold leading-10 text-gray-900 dark:text-indigo-50">Vrün FAQ</h2>
