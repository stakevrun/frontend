    ...
    <div className="w-full max-w-md">
      ...
      <div className="md:flex md:items-center mt-6">
        ...
        <div className="md:w-2/3">
          <input
            className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 inline-full-name"
            id="timezone"
            type="text"
            list="timezones"
